...
<head>
  ...
  <title>Sign In - LNU Smart Nav</title>
...
<body>
  <div class="container">
    ...
    <p class="sub">Don't have an account? <a href="{{ route('signup') }}">Create one</a></p>
    ...
    <!-- Visitor Form -->
    <form method="POST" action="{{ route('visitor.signin') }}" id="visitorForm" class="login-form">
      @csrf
      <div class="form-group">
      ...
      <button type="submit" class="btn-submit">Continue as Visitor</button>
    </form>
